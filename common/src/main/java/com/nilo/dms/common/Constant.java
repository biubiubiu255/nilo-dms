...
public class Constant {
    ...
    public static final String ORDER_HANDLE_CONF="System_order_handle_config";
    ...
    public static final String LOG_CONF="System_log_config";

    public static final String SMS_CONF="System_sms_config";

    public static final String ROUTE_CONF="System_route_config";
    ...
    public static final String ALLOW_URL="/api.html,/captcha/image.html,/account/login.html,/home.html,/account/logout.html," +
        ...
        "/mobile/PorblemController/test.html,/mobile/SjArriveScanController/test.html,/mobile/DeliverScanController/test.html," +
            "/mobile/SendScanController/test.html,/mobile/password/toPage.html,/mobile/login.html,/account/verify.html";
