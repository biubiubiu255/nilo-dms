		...
		<div class="banner_content">
			<form id="arrive-form">
				<div class="banner_content">
					...
					<ul class="one_banner">
						<li><input type='text' placeholder="Logistics No" required="required" property_name="arrive_scan_no" set_attr="placeholder" class='input_value keywords i18n-input' id="logisticsNo" name='logisticsNo' /><span data-locale="all_scan" class="scanner" id="scan">scan</span></li>
