	...
	<div class="wap_content">
		...
		<div class="formula_modify">
			<form id="myForm" class="layui-form" action="">
				<div class="banner_content">
					<ul class="one_banner">
						<li>
							<%--<label>Next Station</label>--%> <select required="required"
							class='input_value' id='nextStation' name='nextStation'>
						...
						<li><input type='text' placeholder="Weight" id="Weight"
							class='input_value' name='Weight' /></li>
						<li><input type='text' placeholder="Length" id="Length"
							class='input_value' name='Length' /></li>
						<li><input type='text' placeholder="Width" id="Width"
							class='input_value' name='Width' /></li>
						<li><input type='text' placeholder="High" id="High"
							class='input_value' name='High' /></li>
						<li><label>Scan Logistics No</label>
							<div class="xq">scan</div></li>
					</ul>

					<div class="bottom_a_button">
						<a onclick="doFind()">submit</a>
					</div>
				</div>
			</form>
		</div>
		<div>
			<table cellpadding="0" id="tab" cellspacing="0" class="pf_div1">
				<tr>
					<td>Logistics No</td>
					<td><input type="checkbox" id="allFuxuan"
