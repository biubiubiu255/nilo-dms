    ...
    <script type="text/javascript">
        $(function () {
            ...
            layui.use(['laydate','table'], function () {
                ...
                tableMe = tab.render({
                    elem: '#${id0}'
                    ,url: '/report/sendExpress/summarizeList.html?exportType=2' //数据接口
                    ,page: true //开启分页
                    ,limit:10
                    ,method: 'post'
                    ,cols: [[ //表头
            ...
            $(".btn-export").on("click", function () {
                if(showPattern==1){
                    window.location.href = "/report/sendExpress/summarizeList.html" + "?limit=1000&" + getParam(1);
                }else {
                    window.location.href = "/report/sendExpress/summarizeList.html" + "?" + getParam(1);
                }
            });
            ...
            function reloadTable() {
                ...
                if (showPattern==0){
                    ...
                    $("#ifm").show();
                    $("#me_tab").hide();
                    var url = "/report/sendExpress/summarizeList.html";
