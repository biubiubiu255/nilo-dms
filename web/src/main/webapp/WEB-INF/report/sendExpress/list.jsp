...
<div class="box-body">
    ...
    <div id="me_tab">
        <table class="layui-table"
               lay-data="{ url:'/report/sendExpress/list.html?exportType=2',method:'post', page:true,limit:10, id:'${id0}'}"
               lay-filter="demo">
            <thead>
            <tr>
                ...
                <th lay-data="{field:'receiveName', width:150}">ReceiveName</th>
    ...
    <iframe scrolling="no" frameborder="0" src="/report/sendExpress/list.html?exportType=0" id="ifm" width="100%" height="100%" style="padding: 0px; display: none;"></iframe>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".btn-export").on("click", function () {
                ...
                if(showPattern==1){
                    url = "/report/sendExpress/list.html?limit=1000&" + param;
                }else {
                    url = "/report/sendExpress/list.html?" + param;
                }
                console.log(url);
            ...
            function reloadTable() {
                if (showPattern==0){
                    ...
                    $("#ifm").show();
                    $("#me_tab").hide();
                    var url = "/report/sendExpress/list.html";
