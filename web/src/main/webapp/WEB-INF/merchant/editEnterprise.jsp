            ...
            <div class="layui-tab-item layui-show">
                ...
                <form id="companyForm" class="layui-form" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="checkbox" name="vip" title="VIP" value="1"
                                   lay-skin="primary" <c:if test="${merchantInfo.vip =='1'}">checked</c:if> >
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <lp:enumTag selectId="country" selectName="country" className="CountryEnum"
                                        code="${merchantInfo.country}" disabled="false" />
                        </div>

                        <label class="layui-form-label">Level</label>
                        <div class="layui-input-inline">
                            <lp:enumTag selectId="level" selectName="level" className="LevelEnum"
                                        code="${merchantInfo.level.code}" disabled="false" />
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <lp:enumTag selectId="type" selectName="type" className="CustomerTypeEnum"
                                        code="${merchantInfo.type.code}" disabled="false" exclude="person"/>
                        </div>
                        <label class="layui-form-label">Nature Type</label>
                        <div class="layui-input-inline">
                            <lp:enumTag selectId="nature" selectName="nature" className="NatureTypeEnum"
                                        code="${merchantInfo.nature.code}" disabled="false"/>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="licence" value="${merchantInfo.licence}" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="idCard" value="${merchantInfo.idCard}" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
            ...
            <div class="layui-tab-item">
                <form id="businessForm" class="layui-form" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" value="${merchantInfo.contactName}" name="contactName" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" value="${merchantInfo.contactPhone}" name="contactPhone" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" value="${merchantInfo.contactEmail}" name="contactEmail" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" value="${merchantInfo.address}" name="address" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
