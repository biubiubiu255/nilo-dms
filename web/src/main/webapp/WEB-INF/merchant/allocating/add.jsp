...
<div class="box-body">
    <form id="myForm" class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select lay-filter="country1" lay-verify="required" name="country">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select lay-filter="province1" id="province1" lay-verify="required" name="province">
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select lay-filter="city1" id="city1" lay-verify="required" name="city">
                </select>
            </div>
    ...
    $(function () {
        ...
        layui.use('form', function () {
            ...
            form.on('submit(add-order-handle-config)', function (data) {
                ...
                $.ajax({
                    url: "/admin/distribution/add.html",
