    ...
    <form id="myForm" class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <lp:enumTag selectId="optTypeAdd" selectName="optTypeAdd" className="OptTypeEnum"
                            code="" disabled="false" />
            </div>
        </div>
        <hr>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="routeDescE" placeholder="Route Desc EN" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">Route Desc CN:</label>
            <div class="layui-input-block">
                <textarea name="routeDescC" placeholder="Route Desc CN" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
    ...
    $(function () {
        layui.use('form', function () {
            ...
            form.on('submit(add-route-config)', function (data) {
                ...
                $.ajax({
                    url: "/systemConfig/route/add.html",
                    data: {
