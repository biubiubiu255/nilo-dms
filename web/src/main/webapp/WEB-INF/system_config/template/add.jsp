        ...
        <div class="layui-tab-content">
            <form id="factorForm" class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="factorDOs[0].fee">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" name="factorDOs[1].fee">
                    </div>
                    <div class="layui-input-inline">
    ...
    $(function () {
        ...
        layui.use('form', function () {
            ...
            form.on('submit(add-basic-fee)', function (data) {
                ...
                $.ajax({
                    url: "/systemConfig/deliveryFeeTemplate/addBasic.html",
            ...
            form.on('submit(add-factor)', function (data) {
                var load = layer.load(2);
                $.ajax({
                    url: "/systemConfig/deliveryFeeTemplate/addFactor.html",
